...
password = quote_plus('<9#iiQa8')


user = "uhccdmt01_actul_load_usr"
password = password
host = 'rn000191348'
port = 3306
database = 'uhccdmt01'
...
GROUP BY ACCOUNT, LEDGER, DRILL_DATE, PROJECT_ID, line_descr, descr, descr254, oprid,journal_id, source,BUSINESS_UNIT,OPERATING_UNIT,
LOCATION,DEPTID,BUS_FLG,posted_date
